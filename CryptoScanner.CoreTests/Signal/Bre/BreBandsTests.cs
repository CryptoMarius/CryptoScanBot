...
namespace CryptoScanner.CoreTests.Signal.Bre;

/// <summary>
/// Unit tests for <see cref="BreBandsHelper"/>: Donchian-based outer bands plus an EMA+ATR
...
public class BreBandsTests
{
    ...
    {
        var result = BreBandsHelper.ComputeBands([]);
    ...
    public void ComputeBands_HasBands_AfterBandLength()
    {
        ...
        int bandLength = GlobalData.Settings.Signal.Bre.BandLength;
    ...
    {
        GlobalData.Settings.Signal.Bre.RequireStochOsOb = false;
        var candles = MakeCandles(WarmupCandles);
        var bands = BreBandsHelper.ComputeBands(candles);
    ...
    {
        GlobalData.Settings.Signal.Bre.RequireStochOsOb = true;
        try
        {
            var candles = MakeCandles(WarmupCandles);
            var bands = BreBandsHelper.ComputeBands(candles);
    ...
    public void IsLongBreak_NoBreak_WhenPriceAboveLowerBand()
    {
        ...
        bool result = BreBandsHelper.IsLongBreak(candles, bands, idx,
    ...
    public void IsShortBreak_NoBreak_WhenPriceBelowUpperBand()
    {
        ...
        bool result = BreBandsHelper.IsShortBreak(candles, bands, idx,
            out double bw, out double bp, out string reason);
    ...
    public void IsLongBreak_WarmingUp_ReturnsFalse()
    {
        ...
        bool result = BreBandsHelper.IsLongBreak(candles, bands, 0,
    ...
    public void IsShortBreak_WarmingUp_ReturnsFalse()
    {
        ...
        bool result = BreBandsHelper.IsShortBreak(candles, bands, 0,
            out _, out _, out string reason);
