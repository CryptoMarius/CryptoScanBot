...
///
/// Kraken Perpetual is a different platform than Kraken Spot with its own, cost based limits
/// (https://docs.kraken.com/api/docs/guides/futures-ratelimits); the public market data endpoints
/// this scanner uses are the cheapest of the lot. A burst of 20 chart requests measured on
/// 14-08-2026 was served at 8 requests per second without an error.
///
