...
public partial class TraderEntryConditionsViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private int _macdCrossoverLookbackBars = 3;
    ...
    public void LoadConfig(SettingsTrading settings)
    {
        ...
        MacdCrossoverLookbackBars = settings.MacdCrossoverLookbackBars;
    ...
    public void SaveConfig(SettingsTrading settings)
    {
        ...
        settings.MacdCrossoverLookbackBars = MacdCrossoverLookbackBars;
