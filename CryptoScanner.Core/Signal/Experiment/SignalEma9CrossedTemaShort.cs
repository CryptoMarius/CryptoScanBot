...
public class SignalEma9CrossedTemaShort : SignalCreateBase
{
    public SignalEma9CrossedTemaShort(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
    }
