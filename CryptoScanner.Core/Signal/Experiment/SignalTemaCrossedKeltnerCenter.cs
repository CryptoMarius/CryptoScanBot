...
public class SignalTemaCrossedKeltnerCenter : SignalCreateBase
{
    public SignalTemaCrossedKeltnerCenter(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
    }
    ...
    public override bool IsSignal()
    {
        ...
        if (GetPrevCandle(CandleLast, out CryptoCandle? candlePrev))
        {
            ...
            {
                if (candlePrev!.CandleData!.Tema > candlePrev.CandleData.KeltnerCenterLine
                    && CandleLast.CandleData!.Tema <= CandleLast.CandleData.KeltnerCenterLine)
                {
                    return true;
                }
            }
