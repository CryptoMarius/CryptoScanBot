...
public class SignalBbmaReentryNewLong : SignalBbmaBase
{
    ...
    /// </summary>
    private bool CheckTf1AlertHistoryLong(out string reason)
    {
        reason = "";
        ...
        for (int i = 0; i < lookback; i++)
        {
            ...
            candle = prev!;
            BbmaTfState state = ClassifyStateLong(candle);
    ...
    /// </summary>
    private bool CheckBbFlatteningLong(out string reason)
    {
        reason = "";
    ...
    public override bool IsSignal()
    {
        ...
        if (!CheckTf1AlertHistoryLong(out string alertReason))
        {
