...
{
    public static void PickupAssets(Model.CryptoExchange activeExchange, IEnumerable<BinanceStreamBalance> balances)
    {
    ...
    public static void PickupAssets(Model.CryptoExchange activeExchange, IEnumerable<BinanceBalance> balances)
    {
        activeExchange.Data.AssetListSemaphore.Wait();
        try
        {
        ...
        //if (GlobalData.ExchangeListName.TryGetValue(ExchangeName, out Model.CryptoExchange? exchange))
        {
            try
            {
                ...
                using var client = new BinanceRestClient();
                {
                    ...
                    try
                    {
                        PickupAssets(activeExchange, accountInfo.Data.Balances);
