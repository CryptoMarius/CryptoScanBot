...
public static class Constants
{
    ...
    public const string StrategyBre = "Bre";
    public const string StrategyAtrRb = "AtrRb";
    public const string StrategyBaba = "Baba";

    public const string StrategyDlz = "Dlz";
    public const string StrategyFvg = "Fvg";
    public const string StrategySmc = "Smc";

    public const string StrategyBbma = "Bbma";
    public const string StrategyJump = "Jump";
