...
public class SignalSma20Crossed50Long : SignalCreateBase
{
    public SignalSma20Crossed50Long(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
    }
