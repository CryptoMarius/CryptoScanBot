...
public class SignalTest1Short : SignalSbmBaseShort
{
    public SignalTest1Short(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
