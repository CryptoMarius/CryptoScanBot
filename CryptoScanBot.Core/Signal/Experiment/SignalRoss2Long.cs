...
public class SignalRoss2Long : SignalCreateBase
{
    public SignalRoss2Long(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
    ...
    public override bool IsSignal()
    {
        ...
        // ********************************************************************
        // price crossed the vwap upwards
