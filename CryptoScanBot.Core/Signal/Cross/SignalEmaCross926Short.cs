...
#if EXTRASTRATEGIES
public class SignalEmaCross926Short : SignalCreateBase
{
    public SignalEmaCross926Short(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
