...
public class SignalMacdShort : SignalCreateBase
{
    public SignalMacdShort(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
