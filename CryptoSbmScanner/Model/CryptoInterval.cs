...
namespace CryptoSbmScanner
{
    ...
    public class CryptoInterval
    {
        ...
        {
            CryptoInterval cryptoInterval = new CryptoInterval();
            cryptoInterval.IntervalPeriod = intervalPeriod;
            cryptoInterval.Name = name;
            cryptoInterval.Duration = duration;
            cryptoInterval.ConstructFrom = constructFrom;
