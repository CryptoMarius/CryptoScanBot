...
public class CryptoPosition
{
    ...
    public PositionStatus? Status { get; set; } //Globale status van de positie (new, closed, wellicht andere enum?)
    ...
    //[Computed]
    //public SortedList<long, CryptoPositionStep> Steps { get; set; } = new SortedList<long, CryptoPositionStep>();
