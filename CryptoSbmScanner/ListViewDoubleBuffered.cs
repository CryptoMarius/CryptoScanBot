...
#if DEBUG
                    case 20:
                        compareResult = ObjectCompare.Compare(signalA.PSarDave, signalB.PSarDave);
                        break;
                    case 21:
                        compareResult = ObjectCompare.Compare(signalA.PSarJason, signalB.PSarJason);
                        break;
                    case 22:
                        compareResult = ObjectCompare.Compare(signalA.PSarTulip, signalB.PSarTulip);
                        break;
#endif
                    default:
                        // Compare via string
                        compareResult = ObjectCompare.Compare(listviewA.SubItems[Sortcolumn].Text, listviewB.SubItems[Sortcolumn].Text);
                        break;
                }
            }
