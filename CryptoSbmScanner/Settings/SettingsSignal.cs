...
namespace CryptoSbmScanner
{
    ...
    public class SettingsSignal
    {
        ...
        public int Sbm3CandlesBbRecovery { get; set; } = 8;
        public decimal Sbm3CandlesBbRecoveryPercentage { get; set; } = 225m;

        // SBM aanvullende condities
        public int SbmCandlesForMacdRecovery { get; set; } = 1;
        ...
        public decimal AnalysisBBMinPercentage { get; set; } = 1.50m;
        public decimal AnalysisBBMaxPercentage { get; set; } = 100.00m;
        public bool LogAnalysisBBMinMaxPercentage { get; set; }
        public bool BbOversoldUseLowHigh { get; set; } = false;
        ...
        //Welke intervallen we gaan analyseren (kan dat beter dynamisch maken, best een stomzinnig rijtje zo)
