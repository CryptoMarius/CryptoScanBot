...
public class SignalMacdLtShort : SignalCreateBase
{
    public SignalMacdLtShort(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
