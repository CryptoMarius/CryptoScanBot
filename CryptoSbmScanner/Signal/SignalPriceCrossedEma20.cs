...
public class SignalPriceCrossedEma20 : SignalCreateBase
{
    public SignalPriceCrossedEma20(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
        SignalSide = CryptoTradeSide.Long;
        SignalStrategy = CryptoSignalStrategy.PriceCrossedEma20;
    }
    ...
    public override bool IsSignal()
    {
        ...
        if ((prevCandle.Open > (decimal)prevCandle.CandleData.Ema20) || (prevCandle.Close > (decimal)CandleLast.CandleData.Ema20))
            return false;
        //if (prevCandle.CandleData.Tema > prevCandle.CandleData.Ema20)
        //    return false;
        ...
        if ((CandleLast.Open > (decimal)CandleLast.CandleData.Ema20) || (CandleLast.Close < (decimal)CandleLast.CandleData.Ema20))
            return false;
        //if (CandleLast.CandleData.Tema < CandleLast.CandleData.Ema20)
        //    return false;
