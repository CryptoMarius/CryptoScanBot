...
partial class DashBoardInformation
{
    ...
    private void InitializeComponent()
    {
        ...
        Controls.Add(labelBmTime);
        Controls.Add(labelBm1h);
        ...
        Controls.Add(labelSymbol1Volume);
        Controls.Add(label10);
        Controls.Add(label9);
        Controls.Add(label8);
        Controls.Add(label7);
        Controls.Add(labelSymbol1Price);
        Controls.Add(labelSymbol5Name);
        Controls.Add(labelSymbol4Name);
        Controls.Add(labelSymbol3Name);
        Controls.Add(labelSymbol2Name);
        Controls.Add(labelSymbol1Name);
        Controls.Add(labelBarometerDateValue);
