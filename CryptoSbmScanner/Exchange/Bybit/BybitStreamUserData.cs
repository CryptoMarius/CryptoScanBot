...
public class BybitStreamUserData
{
    ...
    public async Task StopAsync()
    {
        ...
        GlobalData.AddTextToLogTab("Bybit Stopping user stream");
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
    {
        using BybitClient client = new();
        {
            ...
            //{
            //    GlobalData.AddTextToLogTab("Bybit Error starting user stream: " + userStreamResult.Error.Message);
            //    return;
            //}
            ...
            //else
            //{
            //    GlobalData.AddTextToLogTab("Bybit Error subscribing to spot.userstream " + subscriptionResult.Error.Message);
            //    return;
            //}
        }
    ...
    //        GlobalData.AddTextToLogTab("Bybit ERROR: OrderUpdate " + error.ToString());
    //    }
    //}
    ...
    //    {
    //        GlobalData.Logger.Error(error);
    //        GlobalData.AddTextToLogTab("Bybit ERROR: AccountPositionMessage " + error.ToString());
    //    }
    //}
    ...
    {
        GlobalData.AddTextToLogTab("Bybit price ticker connection lost.");
    }

    private void ConnectionRestored(TimeSpan timeSpan)
    {
        GlobalData.AddTextToLogTab("Bybit price ticker connection restored.");
    }

    private void Exception(Exception ex)
    {
        GlobalData.AddTextToLogTab($"Bybit price ticker connection error {ex.Message} | Stack trace: {ex.StackTrace}");
    }
}
