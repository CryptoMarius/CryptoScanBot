...
namespace CryptoSbmScanner
{
    ...
    public class TrendIndicatorZigZag1
    {
		...
		public readonly List<decimal> _lowBuffer = new List<decimal>();
		public readonly List<decimal> _highBuffer = new List<decimal>();
		public readonly List<decimal> _zigZagBuffer = new List<decimal>();
