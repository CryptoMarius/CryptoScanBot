        ...
        if (SortColumn != null && x is LiveDataViewModel a && y is LiveDataViewModel b)
        {
            try
            {
                int compareResult = SortColumn switch
                {
                    ...
                    LiveDataColumnEnum.Stoch => ObjectCompare.Compare(a.Object.Candle.CandleData?.StochOscillator, b.Object.Candle.CandleData?.StochOscillator),
                    LiveDataColumnEnum.Signal => ObjectCompare.Compare(a.Object.Candle.CandleData?.StochSignal, b.Object.Candle.CandleData?.StochSignal),
                    ...
                    LiveDataColumnEnum.Lux5m => ObjectCompare.Compare(a.Object.Candle.CandleData?.Lux5mValue, b.Object.Candle.CandleData?.Lux5mValue),
