    ...
    public int Compare(CryptoLiveData? a, CryptoLiveData? b)
    {
        ...
        try
        {
            int compareResult = SortColumn switch
            {
                ...
                LiveDataColumnEnum.BB => ObjectCompare.Compare(a.CandleData?.BollingerBandsPercentage, b.CandleData?.BollingerBandsPercentage),
                LiveDataColumnEnum.BbUpper => ObjectCompare.Compare(a.CandleData?.BollingerBandsUpperBand, b.CandleData?.BollingerBandsUpperBand),
                LiveDataColumnEnum.BbLower => ObjectCompare.Compare(a.CandleData?.BollingerBandsLowerBand, b.CandleData?.BollingerBandsLowerBand),
                //LiveDataColumnEnum.AvgBB => ObjectCompare.Compare(a.CandleData?.AvgBB, b.CandleData?.AvgBB),
                LiveDataColumnEnum.MacdValue => ObjectCompare.Compare(a.CandleData?.MacdValue, b.CandleData?.MacdValue),
                LiveDataColumnEnum.MacdSignal => ObjectCompare.Compare(a.CandleData?.MacdSignal, b.CandleData?.MacdSignal),
                LiveDataColumnEnum.MacdHistogram => ObjectCompare.Compare(a.CandleData?.MacdHistogram, b.CandleData?.MacdHistogram),
                LiveDataColumnEnum.Rsi => ObjectCompare.Compare(a.CandleData?.Rsi, b.CandleData?.Rsi),
                LiveDataColumnEnum.StochOscillator => ObjectCompare.Compare(a.CandleData?.StochOscillator, b.CandleData?.StochOscillator),
                LiveDataColumnEnum.StochSignal => ObjectCompare.Compare(a.CandleData?.StochSignal, b.CandleData?.StochSignal),
                LiveDataColumnEnum.Sma200 => ObjectCompare.Compare(a.CandleData?.Sma200, b.CandleData?.Sma200),
                LiveDataColumnEnum.Sma50 => ObjectCompare.Compare(a.CandleData?.Sma50, b.CandleData?.Sma50),
                LiveDataColumnEnum.Sma20 => ObjectCompare.Compare(a.CandleData?.Sma20, b.CandleData?.Sma20),
                LiveDataColumnEnum.PSar => ObjectCompare.Compare(a.CandleData?.PSar, b.CandleData?.PSar),
                LiveDataColumnEnum.LuxIndicator5m => ObjectCompare.Compare(a.CandleData?.Lux5mValue, b.CandleData?.Lux5mValue),
