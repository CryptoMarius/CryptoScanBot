...
#if EXTRASTRATEGIES
public class SignalEngulfingLong : SignalCreateBase
{
    public SignalEngulfingLong(CryptoSymbol symbol, CryptoInterval interval, CryptoCandle candle) : base(symbol, interval, candle)
    {
        ReplaceSignal = false;
